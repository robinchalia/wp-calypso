...
export const ACCOUNT_RECOVERY_RESET_PASSWORD_REQUEST_ERROR = 'ACCOUNT_RECOVERY_RESET_PASSWORD_REQUEST_ERROR';
export const ACCOUNT_RECOVERY_RESET_PASSWORD_REQUEST_SUCCESS = 'ACCOUNT_RECOVERY_RESET_PASSWORD_REQUEST_SUCCESS';
...
export const ACCOUNT_RECOVERY_RESET_SET_VALIDATION_KEY = 'ACCOUNT_RECOVERY_RESET_SET_VALIDATION_KEY';
...
export const ACCOUNT_RECOVERY_RESET_VALIDATE_REQUEST_ERROR = 'ACCOUNT_RECOVERY_RESET_VALIDATE_REQUEST_ERROR';
export const ACCOUNT_RECOVERY_RESET_VALIDATE_REQUEST_SUCCESS = 'ACCOUNT_RECOVERY_RESET_VALIDATE_REQUEST_SUCCESS';
...
export const COMMENTS_CHANGE_STATUS_FAILURE = 'COMMENTS_CHANGE_STATUS_FAILURE';
export const COMMENTS_CHANGE_STATUS_SUCESS = 'COMMENTS_CHANGE_STATUS_SUCESS';
...
export const DOMAIN_MANAGEMENT_CONTACT_DETAILS_CACHE_RECEIVE = 'DOMAIN_MANAGEMENT_CONTACT_DETAILS_CACHE_RECEIVE';
export const DOMAIN_MANAGEMENT_CONTACT_DETAILS_CACHE_REQUEST = 'DOMAIN_MANAGEMENT_CONTACT_DETAILS_CACHE_REQUEST';
export const DOMAIN_MANAGEMENT_CONTACT_DETAILS_CACHE_REQUEST_FAILURE = 'DOMAIN_MANAGEMENT_CONTACT_DETAILS_CACHE_REQUEST_FAILURE';
export const DOMAIN_MANAGEMENT_CONTACT_DETAILS_CACHE_REQUEST_SUCCESS = 'DOMAIN_MANAGEMENT_CONTACT_DETAILS_CACHE_REQUEST_SUCCESS';
export const DOMAIN_MANAGEMENT_CONTACT_DETAILS_CACHE_UPDATE = 'DOMAIN_MANAGEMENT_CONTACT_DETAILS_CACHE_UPDATE';
...
export const HAPPYCHAT_INITIALIZE = 'HAPPYCHAT_INITIALIZE';
...
export const HAPPYCHAT_RECONNECTING = 'HAPPYCHAT_RECONNECTING';
export const HAPPYCHAT_SEND_USER_INFO = 'HAPPYCHAT_SEND_USER_INFO';
...
export const HAPPYCHAT_SET_GEO_LOCATION = 'HAPPYCHAT_SET_GEO_LOCATION';
...
export const IMAGE_EDITOR_SET_IMAGE_MEETS_MINIMUM_DIMENSIONS = 'IMAGE_EDITOR_SET_IMAGE_MEETS_MINIMUM_DIMENSIONS';
...
export const JETPACK_USER_CONNECTION_DATA_REQUEST_FAILURE = 'JETPACK_USER_CONNECTION_DATA_REQUEST_FAILURE';
export const JETPACK_USER_CONNECTION_DATA_REQUEST_SUCCESS = 'JETPACK_USER_CONNECTION_DATA_REQUEST_SUCCESS';
...
export const NPS_SURVEY_SUBMIT_WITH_NO_SCORE_REQUESTING = 'NPS_SURVEY_SUBMIT_WITH_NO_SCORE_REQUESTING';
export const NPS_SURVEY_SUBMIT_WITH_NO_SCORE_REQUEST_FAILURE = 'NPS_SURVEY_SUBMIT_WITH_NO_SCORE_FAILURE';
export const NPS_SURVEY_SUBMIT_WITH_NO_SCORE_REQUEST_SUCCESS = 'NPS_SURVEY_SUBMIT_WITH_NO_SCORE_SUCCESS';
...
export const PUBLICIZE_SHARE_ACTIONS_SCHEDULED_REQUEST = 'PUBLICIZE_SHARE_ACTIONS_SCHEDULED_REQUEST';
export const PUBLICIZE_SHARE_ACTIONS_SCHEDULED_REQUEST_SUCCESS = 'PUBLICIZE_SHARE_ACTIONS_SCHEDULED_REQUEST_SUCCESS';
export const PUBLICIZE_SHARE_ACTIONS_SCHEDULED_REQUEST_FAILURE = 'PUBLICIZE_SHARE_ACTIONS_SCHEDULED_REQUEST_FAILURE';
export const PUBLICIZE_SHARE_ACTIONS_PUBLISHED_REQUEST = 'PUBLICIZE_SHARE_ACTIONS_PUBLISHED_REQUEST';
export const PUBLICIZE_SHARE_ACTIONS_PUBLISHED_REQUEST_SUCCESS = 'PUBLICIZE_SHARE_ACTIONS_PUBLISHED_REQUEST_SUCCESS';
export const PUBLICIZE_SHARE_ACTIONS_PUBLISHED_REQUEST_FAILURE = 'PUBLICIZE_SHARE_ACTIONS_PUBLISHED_REQUEST_FAILURE';
...
export const SIMPLE_PAYMENTS_PRODUCTS_LIST_RECEIVE_UPDATE = 'SIMPLE_PAYMENTS_PRODUCTS_LIST_RECEIVE_UPDATE';
export const SIMPLE_PAYMENTS_PRODUCTS_LIST_RECEIVE_DELETE = 'SIMPLE_PAYMENTS_PRODUCTS_LIST_RECEIVE_DELETE';
